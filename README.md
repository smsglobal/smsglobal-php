...
The OTP request can be cancelled if an OTP is not expired and verified yet. It can be done by either `requestId` or `destination number`. Followings are examples of each method:
